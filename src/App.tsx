...
export default function App() {
  ...
  // Scroll spy in free scroll mode
  useEffect(() => {
  ...
  const renderSectionContent = (index: number) => {
    switch (index) {
      ...
      case 5:
        return <EvidencePackageSummary onNavigateSection={handleSelectSection} />;
      case 6:
        return (
  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen bg-[#F7F7F8] dark:bg-[#070709] text-[#1A1A1A] dark:text-[#E0E0E0] relative selection:bg-[#FF5600]/20 selection:text-[#FF5600] font-manrope antialiased transition-colors duration-300 overflow-x-hidden">
        ...
        {viewMode === 'panel' ? (
          ...
          <main className="relative pt-16 sm:pt-18">
            ...
            <ProofSection
              ...
              onNavigateSection={handleSelectSection}
            />
            <EvidencePackageSummary onNavigateSection={handleSelectSection} />
            <ContactSection
              onOpenBooking={() => setIsBookingOpen(true)}
              onNavigateSection={handleSelectSection}
            />
